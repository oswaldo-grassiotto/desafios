...
public class IdwallFormatterTest {
    ...
    @Before
    public void setUp(){
        this.formatter5Characters = new IdwallFormatter(5);
        this.formatter10Characters = new IdwallFormatter(10);
        this.formatter40Characters = new IdwallFormatter(40);
        this.formatter100Characters = new IdwallFormatter(100);
    }
